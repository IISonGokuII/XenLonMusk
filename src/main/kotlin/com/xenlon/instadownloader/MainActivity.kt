                ...
                when (currentScreen) {
                    ...
                    AppViewModel.Screen.MAIN -> {
                        ...
                        MainScreen(
                            ...
                            onRetryFailedQueueItems = { viewModel.retryFailedQueueItems() },
                            onCancelActiveQueueItems = { viewModel.cancelActiveQueueItems() },
                            onClearFinishedQueueItems = { viewModel.clearFinishedQueueItems() },
                            onLoadReels = { viewModel.loadReels() },
                            onLoadTaggedPosts = { viewModel.loadTaggedPosts() },
                            onLoadArchivedPosts = { viewModel.loadArchivedPosts() },
                            onLoadSavedPosts = { viewModel.loadSavedPosts() },
